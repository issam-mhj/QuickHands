        ...
        <div class="md:hidden hidden" id="mobile-menu">
            <div class="container mx-auto px-4 py-2">
                <div class="backdrop-blur-md bg-white/90 rounded-2xl shadow-lg p-6 space-y-4">
                    <a href="#" class="block text-primary font-medium">Home</a>
                    <a href="#" class="block text-dark hover:text-primary transition-colors">Services</a>
                    <a href="#" class="block text-dark hover:text-primary transition-colors">How It Works</a>
                    <a href="#" class="block text-dark hover:text-primary transition-colors">About</a>
