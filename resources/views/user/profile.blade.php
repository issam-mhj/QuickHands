    ...
    <nav class="bg-white border-b border-border py-2">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            <ul class="flex gap-1">
                ...
                <li><a href="#"
                        class="block px-4 py-3 text-text-medium no-underline font-medium text-sm rounded-md transition hover:text-primary hover:bg-gray-100">Reviews</a>
                </li>
                <li><a href="/user/profile"
                        class="block px-4 py-3 text-primary no-underline font-medium text-sm rounded-md bg-blue-50">Profile
                        & Settings</a></li>
            </ul>
